# ----------------- REQUISIÇÃO E LIMPEZA DE CARACTERES, 
# ----------------- DEPOIS CRIAÇÃO DAS COLUNAS E FINALIZANDO COM NOVO DATAFRAME LIMPO.
...
print('''
    ...
    '''.format(freq_nr[-1][0], freq_nr[0][0], resultado['Combinacao'].values[-1],
